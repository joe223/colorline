...
},{"process":14}],10:[function(require,module,exports) {
"use strict";
...
var game = {
    ...
    start: function start() {
        ...
        var max = body.width() > body.height() ? body.height() : body.width();
...
},{"./util":18}],19:[function(require,module,exports) {
...
},{"../src/util":18}],20:[function(require,module,exports) {
...
},{"../src/util":18}],23:[function(require,module,exports) {
var util = require('../src/util')
var Global = util.Global
...
},{"./localStorage":19,"./oldFF-globalStorage":20,"./oldIE-userDataStorage":21,"./cookieStorage":22,"./sessionStorage":23,"./memoryStorage":24}],25:[function(require,module,exports) {
/* eslint-disable */
...
},{"./lib/json2":25}],11:[function(require,module,exports) {
...
},{"../src/store-engine":15,"../storages/all":16,"../plugins/json2":17}],13:[function(require,module,exports) {
var bundleURL = null;
...
var app = window.app = new _vueEsm2.default({
    el: '#app',
    data: {
        difficulty: 3, // 默认简单
        list: [],
    ...
    mounted: function mounted() {
        ...
        var body = (0, _jquery2.default)('body');
        this.list = _store2.default.get('history') || [];
    ...
    methods: {
        ...
        saveData: function saveData(data) {
            ...
            _store2.default.set('history', this.list);
            var conti = confirm("游戏结束，是否继续？");
...
},{"./game":10,"jquery":8,"vue/dist/vue.esm.js":12,"store":11,"./game.scss":9}],26:[function(require,module,exports) {
var global = arguments[3];
